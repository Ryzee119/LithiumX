...
//FIXME: Should be xboxkrnl.h probably
...
#ifndef RX_RING_SIZE
#define RX_RING_SIZE 64 //Should be >= 2
#endif
#ifndef TX_RING_SIZE
#define TX_RING_SIZE 64 //Should be >= 4
#endif

//Must be greated than max frame size. A multiple of page size prevents page boundary crossing
